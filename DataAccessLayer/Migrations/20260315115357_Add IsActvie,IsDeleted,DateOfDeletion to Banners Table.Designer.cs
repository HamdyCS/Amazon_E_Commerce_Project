...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20260315115357_Add IsActvie,IsDeleted,DateOfDeletion to Banners Table")]
    partial class AddIsActvieIsDeletedDateOfDeletiontoBannersTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccessLayer.Entities.Application", b =>
                {
                    ...
                    b.Property<long?>("ReturnApplicationId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DataAccessLayer.Entities.ApplicationOrderType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DataAccessLayer.Entities.Banner", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DataAccessLayer.Entities.SellerProductInShoppingCart", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("SellerProductsInShoppingCarts", (string)null);
                });
            ...
            modelBuilder.Entity("DataAccessLayer.Entities.ApplicationOrder", b =>
                {
                    ...
                    b.HasOne("DataAccessLayer.Entities.ApplicationOrderType", "ApplicationOrderType")
                        .WithMany("ApplicationOrders")
            ...
            modelBuilder.Entity("DataAccessLayer.Entities.SellerProductInShoppingCart", b =>
                {
                    ...
                    b.HasOne("DataAccessLayer.Entities.ShoppingCart", "ShoppingCart")
                        .WithMany("SellerProductsInShoppingCart")
                        .HasForeignKey("ShoppingCartId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
            ...
            modelBuilder.Entity("DataAccessLayer.Entities.ShoppingCart", b =>
                {
                    ...
                    b.Navigation("SellerProductsInShoppingCart");
