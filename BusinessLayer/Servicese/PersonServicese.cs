...
{
    public class PersonServicese : IPersonServices
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IGenericMapper _genericMapper;
        private readonly ILogger<PersonServicese> _logger;

        public PersonServicese(IUnitOfWork unitOfWork, IGenericMapper genericMapper, ILogger<PersonServicese> logger)
        {
